  ...
  return (
    <div className="">
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-4 py-4 overflow-y-auto bg-primary bg-[#E5C3A6]">
          <div className="flex items-center justify-center text-5xl text-black p-2">
            Kedai Alfahmi
          </div>
            ...
            <ul className="flex-col gap-10">
              <li className="absolute flex items-center justify-center inset-x-0 mt-16">
                ...
                href="/product/product-page"
                  type="button"
                  className="w-[80%] p-3 flex gap-4 text-start justify-start items-center text-sm font-medium text-black rounded-lg"
                >
                  <svg
                    width="29"
                    height="29"
              ...
              <li className="absolute flex items-center justify-center inset-x-0 mt-[205px] ">
                ...
                href="/user/user-page"
                  type="button"
                  className="w-[80%] p-3 flex gap-4 text-start justify-start items-center text-sm font-medium rounded-lg  text-black  "
                >
                  <svg
                    width="33"
                    height="32"
